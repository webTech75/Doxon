...
$(document).ready(function() {
  ...
  var startConversation = function(index) {
    ...
    console.log("Dialog: " + dialog + "index: " + index);
    var dialogId = '1f3fa9c3-0551-4bdc-9ee4-d9510c6c43f6';
    $conversation.empty();
    ...
    $.post(context + '/v1/dialogs/' + dialogId + '/conversation', {input: ''})
    .done(function(data) {
      $conversation.empty();
      $information.empty();
      ...
      synthesizeRequest(data.response);
    });
  };
 ...
 // start conversation the dialogs
  $('#start-conv').click(function(){
    var self = this;
    getDialogs();
    startConversation(0);
  });
